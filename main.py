...
m.place(x=82,y=100)
m = tkinter.Button(root, text = 'Download queue', command=queued_downl, bg='grey')
m.place(x=182,y=100)
m = tkinter.Button(root, text = 'Clear queue', command=clear_queue, bg='grey')
m.place(x=0,y=125)
m = tkinter.Button(root, text = 'Show queue', command=show_queue, bg='grey', width='11')
m.place(x=82,y=125)
m = tkinter.Button(root, text = 'Exit app', command=exit, bg='grey', width='14')
m.place(x=182,y=125)
