...
m = tkinter.Button(root, text = 'Download', command=downl_vid)
m.place(x=0,y=100)
m = tkinter.Button(root, text = 'Add to queue', command=add_to_queued_downl)
m.place(x=82,y=100)
m = tkinter.Button(root, text = 'Queue download', command=queued_downl)
m.place(x=182,y=100)
m = tkinter.Button(root, text = 'Clear queue', command=clear_queue)
m.place(x=0,y=125)
m = tkinter.Button(root, text = 'Show queue', command=show_queue)
m.place(x=82,y=125)
